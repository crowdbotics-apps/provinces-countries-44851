...
## Project Structure
    ...
    ├── provinces_countries_44851  # Django project configurations
...
1. Clone this repo and `cd provinces_countries_44851`
...
2. Clone this repo and `cd provinces_countries_44851`
